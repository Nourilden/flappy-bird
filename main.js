...
window.onload = function () {
  ...
  setInterval(placePipes, 2000); // Place pipes every 2 seconds
  setInterval(placeClouds, 3000); // Place clouds every 3 seconds
  setInterval(placeCoins, 4000); // Place coins every 4 seconds
